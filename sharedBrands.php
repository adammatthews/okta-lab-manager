...
$brandStore = new \SleekDB\Store('brands', __DIR__ . "/myDatabase", $dbConfig);
$allBrands = $brandStore->findBy(["userID", "=", "shared"],["_id" => "asc"]);
...
<div class="row">
		...
		<div class="card-body">
			<img class="card-img-top img-card-bg" src="<?php echo $brand["Background"];?>" alt="Dist Photo 1">
			<img class="fishes" src="<?php echo $brand["Logo"];?>" alt="Dist Photo 1">
			<!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
		</div>
		<div class="card-footer text-muted">
		<span style="float: left; margin-left:10px;">
		<form action="<?php echo ROUTE_URL_INDEX;?>/sharedBrands" method="post">
